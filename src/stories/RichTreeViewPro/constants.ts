import { TreeViewBaseItem } from "../../components/RichTreeViewPro";
          ...
          },
          {
            ...
            children: [
              ...
              },
              {
                ...
                label: "Folder Gamma",
                children: [
                  { id: "item-4", label: "Item 4", mediaType: "file" },
                ],
              },
            ],
          },
...
export const sharedArgTypes: RichTreeViewStoryObj["argTypes"] = {
  checkboxSelection: {
    control: "boolean",
  },
  isItemEditable: {
...
export const sharedArgs: RichTreeViewStoryObj["args"] = {
